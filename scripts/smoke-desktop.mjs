...
try {
  ...
  assert.deepEqual(bridge.methods, ['autofill', 'getAiStatus', 'getPrintInbox', 'onOpenPdf', 'openPdf', 'openPdfs', 'openProject', 'saveProject', 'openPrintInbox', 'printPdf', 'savePdf', 'chooseCertificate', 'inspectCertificate', 'signAndSavePdf'].sort());
