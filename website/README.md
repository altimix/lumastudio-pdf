...
アプリ配布物は公開 [GitHub Release v1.0.1](https://github.com/altimix/lumastudio-pdf/releases/tag/v1.0.1) のポータブルEXE・Mac ZIPに直接リンクします。LumaStudioシリーズの共通問い合わせ窓口は `https://altimix.co.jp/contact/` です。公開作業時は `VERIFY_DOWNLOADS=1` を設定してリンクを検査します。
