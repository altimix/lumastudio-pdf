...
- `public/assets/ando2026.png`: 安藤昇の提供写真。著作権者の権利を留保します。LumaStudio PDF公式サイトでの表示を目的に提供されたもので、ソースコードの GPL-3.0-only ライセンスには含まれません。写真の再利用には権利者の別途の許可が必要です。
...
利用者がアプリに読み込むPDF、印鑑画像、証明書、作業データはこのリポジトリに含まれません。
